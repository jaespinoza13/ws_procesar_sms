    ...
    public class SmsServices
    {
        ...
        public async Task<ResSmsPorProcesar> GetSmsPorProcesar()
        {
            ...
            var log_body = new LogBody
            {
             ...
             _ =_logsService.SaveHeaderLogs( log_body, strOperacion, MethodBase.GetCurrentMethod()!.Name, _clase );
            ...
            {
                 _ = _logsService.SaveExceptionLogs( log_body.Spread( res_val ), strOperacion, MethodBase.GetCurrentMethod()!.Name, _clase, ex );
                throw new ArgumentException("Error al obtener los sms por procesar.");
            }
            _=_logsService.SaveResponseLogs( log_body.Spread( res_val ), strOperacion, MethodBase.GetCurrentMethod()!.Name, _clase );
            return res_val;
        }
        ...
        public async Task<ResValidarSms> ValidarSms(ReqValidarSms reqValidarSms, string str_login, string str_ip_dispositivo)
        {
            ...
            var log_body = new LogBody
            {
             ...
             _ = _logsService.SaveHeaderLogs( log_body.Spread( reqValidarSms ), strOperacion, MethodBase.GetCurrentMethod()!.Name, _clase );
            ...
            try
            {
                ...
                if (res_tran.codigo.Equals( "000" ))
                {
                 ...
                 _ = _logsService.SaveResponseLogs( log_body.Spread( respuesta ), strOperacion, MethodBase.GetCurrentMethod()!.Name, _clase );
                return respuesta;
            }
            catch (Exception ex)
            {
                 _ = _logsService.SaveExceptionLogs( log_body.Spread( respuesta ), strOperacion, MethodBase.GetCurrentMethod()!.Name, _clase, ex );
        ...
        public async Task<ResProcesarTransf> ProcesarTransferencia(ReqProcesarTransf req_procesar_transf, string str_ip_dispositivo)
        {
            ...
            var log_body = new LogBody
            {
             ...
             _ = _logsService.SaveHeaderLogs( log_body.Spread( req_procesar_transf ), strOperacion, MethodBase.GetCurrentMethod()!.Name, _clase );
        ...
        public async Task<ResAgregarSms> GuardarSmsSocio(ReqAgregarSms req_agregar_sms)
        {
            ...
            var log_body = new LogBody
            {
             ...
             _ = _logsService.SaveHeaderLogs( log_body.Spread( req_agregar_sms.sms, new { estado = req_agregar_sms.str_sms_estado } ), strOperacion, MethodBase.GetCurrentMethod()!.Name, _clase );
        ...
        public async Task ActualizarEstadoSms(int int_sms_id, string str_estado_sms, string str_login, string str_ip_dispositivo)
        {
            ...
            var log_body = new LogBody
            {
             ...
             _ = _logsService.SaveResponseLogs( log_body.Spread( new { sms_id = int_sms_id, estado = str_estado_sms }), strOperacion, MethodBase.GetCurrentMethod()!.Name, _clase );
            ResProcesarTransf respuesta = new();
            try
            {
